    ...
    <div className="pt-24 bg-white text-[#171717]">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="mb-6 text-[#171717]">KALP</h1>
      ...
      <section className="py-16 md:py-24 bg-[#F5F5F5]">
        <div className="container-custom">
          ...
          >
            <h2 className="mb-6 text-[#171717]">KALP Services</h2>
        ...
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="mb-6 text-[#171717]">Why Choose KALP?</h2>
              <div className="space-y-4">
                {benefits.map((benefit, index) => (
                  ...
                  >
                    <span className="flex-shrink-0 h-6 w-6 rounded-full bg-gold flex items-center justify-center mr-3 mt-0.5">
            ...
            >
              ...
              <div className="flex items-center">
                <div className="w-12 h-12 bg-[#E5E5E5] rounded-full mr-4"></div>
                <div>
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div
              ...
              transition={{ duration: 0.8 }}
            >
              <h2 className="mb-6 text-[#171717]">Ready to Experience KALP?</h2>
